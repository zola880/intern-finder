...
// Helper to safely require a route module
function safeRequire(modulePath, moduleName) {
  try {
    const mod = require(modulePath);
    if (typeof mod === 'function' || (mod && typeof mod === 'object' && mod.router)) {
...
const companyApplicationRoutes = safeRequire('./routes/companyApplicationRoutes', 'companyApplicationRoutes');
