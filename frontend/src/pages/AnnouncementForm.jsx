...
const AnnouncementForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (file) formDataToSend.append("acceptanceLetter", file);
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-sm">
        <div className="p-8 bg-emerald-600 text-white flex items-center justify-between">
          <div>
            ...
            <p className="text-emerald-100 text-sm mt-1">Notify university about your secured internship</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          {error && (
            <div className="bg-red-50 dark:bg-red-900/20 text-red-700 p-4 rounded-xl">
              {error}
            </div>
          )}
